...
def onAppStart(app):
    ...
    app.circles = []
    app.state = state
    app.displayText = "HACK 112! Use your hands to make a change "  
    app.displayText1 = "Presendted by the team MMA"  
    app.displayText2 = "Mano, Mukhammed, Alan"  
    app.backgroundImage = "background.jpg"
def redrawAll(app):
    ...
    drawLabel(app.displayText, 20, 20, size=40, fill='blue', align='left')
    drawLabel(app.displayText1, 20, 80, size=40, fill='red', align='left')
    drawLabel(app.displayText2, 20, 140, size=40, fill='green', align='left')
